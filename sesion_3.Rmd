...
... crear una columna con el número de cracteres que tiene x2
...
A diferencia de la función de R base `ifelse()`, la 
...
¿Es posible utilizar `if_else()` para crear variables con más categorías?
...
- **tramos1**: asigna el valor 1 si la edad es menor que 15, el valor 2 si 
la edad es mayor o igual a 15 y menor o igual que 30 y el valor 3 si la edad es mayor a 30.
...
Podríamos usar la función `filter()` y luego la función `mean()`. Pero, ¿si 
queremos calcular el número de registros para muchas categorías de un 
dataframe?
...
Retomemos el ejercicio 3 de la primera sesión:
...
- *vaues_from*: columna desde la cual extraer los valores
